...
extern char espRead8(const void *addr);		//@@
...
void tfp_printf(const char *fmt, ...)
{
    ...
    va_end(va);
	stdout_putf(stdout_putp, 0);		// 0 won't be output. let stdout_putf know this string ended
}
#endif
