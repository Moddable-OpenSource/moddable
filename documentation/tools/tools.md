...
This document describes the tools provided by Moddable to build, debug, and run JavaScript apps on microcontrollers or in the Moddable simulator, **Screen Test**.
...
will build and launch the [balls example](../../examples/piu/balls) in **Screen Test**,
...
A video demonstration of Screen Test is available [here](https://www.youtube.com/watch?v=2ZFQ14Grc70).
