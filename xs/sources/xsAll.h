...
#define mxModuleInstanceHosts(MODULE)			((MODULE)->next->next->next->next)
#define mxModuleInstanceMeta(MODULE)			((MODULE)->next->next->next->next->next)
#define mxModuleInstanceTransfers(MODULE)		((MODULE)->next->next->next->next->next->next)
#define mxModuleInstanceInitialize(MODULE)		((MODULE)->next->next->next->next->next->next->next)
#define mxModuleInstanceExecute(MODULE)			((MODULE)->next->next->next->next->next->next->next->next)
