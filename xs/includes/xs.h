...
#define xsSuppressedErrorPrototype (the->stackPrototypes[-18])
#define xsSymbolPrototype (the->stackPrototypes[-19])
#define xsArrayBufferPrototype (the->stackPrototypes[-20])
#define xsDataViewPrototype (the->stackPrototypes[-21])
#define xsTypedArrayPrototype (the->stackPrototypes[-22])
#define xsMapPrototype (the->stackPrototypes[-23])
#define xsSetPrototype (the->stackPrototypes[-24])
#define xsWeakMapPrototype (the->stackPrototypes[-25])
#define xsWeakSetPrototype (the->stackPrototypes[-26])
#define xsPromisePrototype (the->stackPrototypes[-27])
#define xsProxyPrototype (the->stackPrototypes[-28])
