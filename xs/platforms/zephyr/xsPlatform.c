...
void zephyr_reset();
	...
	#define mxDebugMutexTake() k_mutex_lock(&gDebugMutex, K_FOREVER)
	#define mxDebugMutexGive() k_mutex_unlock(&gDebugMutex)
	#define mxDebugMutexAllocated() (gDebugMutex_initialized)
