(() => {
  ...
  var init_define_EXODUS_TEST_FILES = __esm({
    "<define:EXODUS_TEST_FILES>"() {
      define_EXODUS_TEST_FILES_default = [["tests/jest", "timers.async.test.js"]];
    }
  });
  ...
  var init_define_process_argv = __esm({
    "<define:process.argv>"() {
      define_process_argv_default = ["exodus-test", "/Users/chalker/repo/Exodus/test/tests/jest/timers.async.test.js"];
    }
  });
...
Also, using expect.assertions() to ensure the planned number of assertions is being called is advised for async code.`
  ...
  var timers_async_test_exports = {};
  var delayTime, delay100cycles, testTimers;
  var init_timers_async_test = __esm({
    "tests/jest/timers.async.test.js"() {
      "use strict";
      init_define_EXODUS_TEST_FILES();
      init_define_EXODUS_TEST_FSDIRS();
      ...
      init_define_process_argv();
      jest.useFakeTimers();
      delayTime = /* @__PURE__ */ __name((ms) => new Promise((resolve) => setTimeout(resolve, ms)), "delayTime");
      delay100cycles = /* @__PURE__ */ __name(async () => {
      ...
      testTimers("advanceTimersByTimeAsync() lets microtasks to pass, async chain", async () => {
        ...
        doStuff(fn);
        await jest.advanceTimersByTimeAsync(1e4);
        expect(fn).toHaveBeenCalled();
      });
    }
  });
  ...
  (async function() {
    try {
      globalThis.EXODUS_TEST_CRYPTO_ENTROPY = "";
      ;
...
This activity created errors and would have caused tests to fail, but instead triggered unhandledRejection events`);
      ...
      ;
      await Promise.resolve().then(() => (init_timers_async_test(), timers_async_test_exports));
    } catch (err) {
      print(err);
