(() => {
  ...
  var init_define_EXODUS_TEST_FILES = __esm({
    "<define:EXODUS_TEST_FILES>"() {
      define_EXODUS_TEST_FILES_default = [["tests/jest", "timers.infinite.test.js"]];
    }
  });
  ...
  var init_define_process_argv = __esm({
    "<define:process.argv>"() {
      define_process_argv_default = ["exodus-test", "/Users/chalker/repo/Exodus/test/tests/jest/timers.infinite.test.js"];
    }
  });
...
`))) return;
  ...
  var require_engine_pure = __commonJS({
    "src/engine.pure.cjs"(exports, module) {
      ...
      var { setTimeout: setTimeout5, setInterval: setInterval2, setImmediate: setImmediate2, Date: Date2 } = globalThis;
      ...
      var MockTimers = class {
        ...
        reset() {
          this.#enabled = false;
          Object.assign(globalThis, { setTimeout: setTimeout5, setInterval: setInterval2, setImmediate: setImmediate2, Date: Date2 });
...
`;
  ...
  var setImmediate, setTimeout2, clearTimeout, EVENT_TYPES, METHODS, GETTERS, SETTERS, USER_CALLED, noUndef, throwLater, EventQueue, EventTargetClass, BaseWebSocket, RecordWebSocket, ReplayWebSocket;
  var init_websocket = __esm({
    "node_modules/.pnpm/@exodus+replay@1.0.0-rc.9/node_modules/@exodus/replay/websocket.js"() {
      ...
      init_define_process_argv();
      init_util();
      ({ setImmediate, setTimeout: setTimeout2, clearTimeout } = globalThis);
...
${sep(60)}`;
      ...
      timersDebug = /* @__PURE__ */ __name(async (...times) => {
        ...
        for (const time of times) {
          await new Promise((resolve) => setTimeout3(resolve, time));
...
Also, using expect.assertions() to ensure the planned number of assertions is being called is advised for async code.`
  ...
  // tests/jest/timers.infinite.test.js
  var timers_infinite_test_exports = {};
  ...
  var testTimers;
  var init_timers_infinite_test = __esm({
    "tests/jest/timers.infinite.test.js"() {
      "use strict";
      init_define_EXODUS_TEST_FILES();
      init_define_EXODUS_TEST_FSDIRS();
      ...
      init_define_EXODUS_TEST_SNAPSHOTS();
      init_define_process_argv();
      __name(infiniteTimerGame, "infiniteTimerGame");
      jest.useFakeTimers();
      ...
      describe("infiniteTimerGame", () => {
        testTimers("schedules a 10-second timer after 1 second", () => {
          ...
          expect(setTimeout).toHaveBeenLastCalledWith(expect.any(Function), 1e3);
          jest.runOnlyPendingTimers();
          expect(callback).toHaveBeenCalled();
          expect(setTimeout).toHaveBeenCalledTimes(2);
          expect(setTimeout).toHaveBeenLastCalledWith(expect.any(Function), 1e4);
        });
      });
    }
  });
  ...
  (async function() {
    try {
      globalThis.EXODUS_TEST_CRYPTO_ENTROPY = "";
      ;
...
This activity created errors and would have caused tests to fail, but instead triggered unhandledRejection events`);
      ...
      ;
      await Promise.resolve().then(() => (init_timers_infinite_test(), timers_infinite_test_exports));
    } catch (err) {
      print(err);
