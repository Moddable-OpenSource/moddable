(() => {
  ...
  var init_define_EXODUS_TEST_FILES = __esm({
    "<define:EXODUS_TEST_FILES>"() {
      define_EXODUS_TEST_FILES_default = [["tests/jest", "timers.order.real.test.js"]];
    }
  });
  ...
  var init_define_process_argv = __esm({
    "<define:process.argv>"() {
      define_process_argv_default = ["exodus-test", "/Users/chalker/repo/Exodus/test/tests/jest/timers.order.real.test.js"];
    }
  });
...
Also, using expect.assertions() to ensure the planned number of assertions is being called is advised for async code.`
  ...
  // tests/jest/timers.order.real.test.js
  var timers_order_real_test_exports = {};
  var N, time;
  var init_timers_order_real_test = __esm({
    "tests/jest/timers.order.real.test.js"() {
      "use strict";
      init_define_EXODUS_TEST_FILES();
      init_define_EXODUS_TEST_FSDIRS();
  ...
  (async function() {
    try {
      globalThis.EXODUS_TEST_CRYPTO_ENTROPY = "";
      ;
...
This activity created errors and would have caused tests to fail, but instead triggered unhandledRejection events`);
      ...
      ;
      await Promise.resolve().then(() => (init_timers_order_real_test(), timers_order_real_test_exports));
    } catch (err) {
      print(err);
