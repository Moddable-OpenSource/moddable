(() => {
  ...
  var init_define_EXODUS_TEST_FILES = __esm({
    "<define:EXODUS_TEST_FILES>"() {
      define_EXODUS_TEST_FILES_default = [["tests/jest", "snapshot.test.js"]];
    }
  });
  ...
  var init_define_process_argv = __esm({
    "<define:process.argv>"() {
      define_process_argv_default = ["exodus-test", "/Users/chalker/repo/Exodus/test/tests/jest/snapshot.test.js"];
    }
  });
...
`))) return;
  ...
  var require_engine_pure = __commonJS({
    "src/engine.pure.cjs"(exports, module) {
      ...
      var { setTimeout: setTimeout4, setInterval: setInterval2, setImmediate: setImmediate2, Date: Date2 } = globalThis;
      ...
      var Context = class {
        ...
        describe = /* @__PURE__ */ __name((...args) => describe4(...args), "describe");
        // TODO: bind to context
      ...
      function exitContext() {
        ...
        if (context2 === context2.root) willstart = setTimeout4(run, 0);
      }
      ...
      async function run() {
        ...
        setTimeout4(() => abstractProcess._maybeProcessExitCode?.(), 0);
      }
      __name(run, "run");
      async function describe4(...args) {
      ...
      __name(describe4, "describe");
      describe4.skip = (...args) => {
        const { name: name2, options, fn } = parseArgs2(args);
        return describe4(name2, { ...options, skip: true }, fn);
      };
      describe4.only = (...args) => {
        const { name: name2, options, fn } = parseArgs2(args);
        return describe4(name2, { ...options, only: true }, fn);
      };
      function plan(count) {
      ...
      var MockTimers = class {
        ...
        reset() {
          this.#enabled = false;
          Object.assign(globalThis, { setTimeout: setTimeout4, setInterval: setInterval2, setImmediate: setImmediate2, Date: Date2 });
      ...
      function getMacrotick() {
        ...
        if (setImmediate2) return () => new Promise((resolve) => setImmediate2(resolve));
        if (MessageChannel) {
          return async () => {
      ...
      module.exports = {
        ...
        ...{ mock: mock2, describe: describe4, test: test4, beforeEach: beforeEach3, afterEach: afterEach3, before: before2, after: after2 },
  ...
  var init_engine = __esm({
    "src/engine.js"() {
      ...
      ({ mock, describe: describe2, test: test2, beforeEach, afterEach, before, after } = import_engine_select.default);
  ...
  async function installJestEnvironment(jestGlobals) {
    ...
    const { jest: jest2 } = jestGlobals;
    const c = config;
    Error.stackTraceLimit = 100;
    if (c.injectGlobals) Object.assign(globalThis, jestGlobals);
    if (c.globals) Object.assign(globalThis, config.globals);
    if (c.fakeTimers?.enableGlobally) jest2.useFakeTimers();
    if (c.clearMocks) beforeEach3(() => jest2.clearAllMocks());
    if (c.resetMocks) beforeEach3(() => jest2.resetAllMocks());
    if (c.restoreMocks) beforeEach3(() => jest2.restoreAllMocks());
    if (c.resetModules) beforeEach3(() => jest2.resetModules());
    let dynamicImport;
    if (true) {
...
'${matcherUtils.stringify(result)}' was returned`
  ...
  function splitTime(time, min = 1e3) {
    const minSteps = Math.min(min, time);
    const step = divisor1000(Math.floor(time / minSteps));
    const steps = Math.floor(time / step);
...
`;
  ...
  var setImmediate, setTimeout, clearTimeout, EVENT_TYPES, METHODS, GETTERS, SETTERS, USER_CALLED, noUndef, throwLater, EventQueue, EventTargetClass, BaseWebSocket, RecordWebSocket, ReplayWebSocket;
  var init_websocket = __esm({
    "node_modules/.pnpm/@exodus+replay@1.0.0-rc.9/node_modules/@exodus/replay/websocket.js"() {
      ...
      init_define_process_argv();
      init_util();
      ({ setImmediate, setTimeout, clearTimeout } = globalThis);
...
`);
  ...
  // src/timers-track.js
  var getStack, setTimeout2, setInterval, clearTimeout2, clearInterval, timersMap, timersMockEnabled, timersTrack, timersList, timersListFormatted, timersDebug, timersAssert;
  var init_timers_track = __esm({
    "src/timers-track.js"() {
      ...
      ({ setTimeout: setTimeout2, setInterval, clearTimeout: clearTimeout2, clearInterval } = globalThis);
      ...
      timersTrack = /* @__PURE__ */ __name(() => {
        const mock2 = {
          ...
          setTimeout(callback, ms, ...args) {
            ...
            const value = setTimeout2(wrapped, ms, ...args);
...
${sep(60)}`;
      ...
      timersDebug = /* @__PURE__ */ __name(async (...times) => {
        ...
        for (const time of times) {
          await new Promise((resolve) => setTimeout2(resolve, time));
  ...
  var init_exodus = __esm({
    "src/exodus.js"() {
      ...
      timersSpeedup = /* @__PURE__ */ __name((rate, { apis = ["setTimeout", "setInterval", "Date"] } = {}) => {
        ...
        const { setTimeout: setTimeout4, setInterval: setInterval2, Date: OrigDate } = globalThis;
        for (const api of apis) {
          if (api === "setTimeout") {
            globalThis.setTimeout = (fn, ms, ...args) => setTimeout4(fn, Math.ceil(ms / rate), ...args);
  ...
  var import_dark4, import_expect2, import_pretty_format3, import_expect3, getCallerLocation, installLocationInNextTest, setTimeout3, inband, addStatefulApis, defaultTimeout, defaultConcurrency, formatArg, eachCallerLocation, makeEach, execArgv, forceExit, inConcurrent, inDescribe, concurrent, describeRaw, testRaw, describe3, test3, jest, wrapCallback, beforeEach2, afterEach2, beforeAll, afterAll, should;
  var init_jest = __esm({
    "src/jest.js"() {
      "use strict";
      init_define_EXODUS_TEST_FILES();
      ...
      ({ setTimeout: setTimeout3 } = globalThis);
...
Also, using expect.assertions() to ensure the planned number of assertions is being called is advised for async code.`
      ...
      describe3 = makeDescribe(describe2);
      describe3.only = makeDescribe(describe2.only);
      describe3.skip = makeDescribe(describe2.skip);
      ...
      describe3.each = makeEach(describe3);
      describe3.only.each = makeEach(describe3.only);
      describe3.skip.each = makeEach(describe3.skip);
  ...
  var require_setup = __commonJS({
    "tests/jest/setup.cjs"() {
      ...
      if (!globalThis.jest) {
        ...
        const { jest: jest2 } = (init_jest(), __toCommonJS(jest_exports));
        globalThis.jest = jest2;
      }
    }
  });
  ...
  var require_module = __commonJS({
    "bundler/modules/module.cjs"(exports, module) {
      "use strict";
      init_define_EXODUS_TEST_FILES();
      init_define_EXODUS_TEST_FSDIRS();
      init_define_EXODUS_TEST_FSFILES();
      ...
      init_define_EXODUS_TEST_SNAPSHOTS();
      init_define_process_argv();
      var ids = "Module,SourceMap,builtinModules,findSourceMap,globalPaths,isBuiltin,runMain".split(",");
      var makeMethod = /* @__PURE__ */ __name((key) => {
        return function() {
          throw new Error(`module.${key} unsupported in bundled mode`);
        };
      }, "makeMethod");
      var createRequire = /* @__PURE__ */ __name((filename) => (file) => {
        const clean = file.replace(/^node:/, "");
        if (globalThis.EXODUS_TEST_MOCK_BUILTINS?.has(clean)) return EXODUS_TEST_MOCK_BUILTINS.get(clean);
  ...
  var snapshot_test_exports = {};
  var TEST_ONE, TEST_TWO, TEST_THREE;
  var init_snapshot_test = __esm({
    "tests/jest/snapshot.test.js"() {
      "use strict";
      init_define_EXODUS_TEST_FILES();
      init_define_EXODUS_TEST_FSDIRS();
      ...
      TEST_ONE = { a: 20, d: Buffer.from("foo"), b: [1, 2, "bar", 5], e: { foo: "bar" } };
      TEST_TWO = { ["__proto__"]: [], b: [1, 2, , , 5], e: { foo: "bar" }, f: -Infinity };
      TEST_THREE = [new Error("?!"), new TypeError("bar"), new Uint16Array([4, 2, 65123]), null];
      it("test A", () => {
...
`);
      ...
      describe("weird  names", () => {
        const ascii = Array.from({ length: 128 }).fill().map((a, i) => i).slice(32).map((i) => String.fromCodePoint(i)).join("");
        for (const key of ["\n", "{}", "$", "`", ">", "` ` `", "` `\n `", "\\", "\\\n`\n\\``", ascii]) {
          it(key, () => {
...
`);
    ...
    "c": [
      ...
      it("supports named snapshots", async () => {
        ...
        try {
          ...
          const require2 = createRequire("file:///Users/chalker/repo/Exodus/test/tests/jest/snapshot.test.js");
          snapshots = require2("./__snapshots__/snapshot.test.js.snap");
        } catch {
          return;
        }
        if (Object.keys(snapshots).join(",") === "default") return;
        [
          ...
          expect(Object.hasOwn(snapshots, name2)).toBe(true);
        });
      });
    }
  });
  ...
  (async function() {
    try {
      globalThis.EXODUS_TEST_CRYPTO_ENTROPY = "";
      ;
      ...
      if (false) {
        const { setTimeout: setTimeout5, setInterval: setInterval2, clearTimeout: clearTimeout3, clearInterval: clearInterval2 } = globalThis.os;
        Object.assign(globalThis, { setTimeout: setTimeout5, setInterval: setInterval2, clearTimeout: clearTimeout3, clearInterval: clearInterval2 });
      ...
      const { setTimeout: setTimeout4 } = globalThis;
      const isBarebone = "1";
      if (typeof process === "undefined") {
        const process2 = {
          __proto__: null,
...
This activity created errors and would have caused tests to fail, but instead triggered unhandledRejection events`);
          ...
          setTimeout4(() => globalThis.EXODUS_TEST_PROCESS._maybeProcessExitCode(), 0);
        }, "logHeader");
        if (false) {
      ...
      ;
      await Promise.resolve().then(() => (init_snapshot_test(), snapshot_test_exports));
    } catch (err) {
      print(err);
