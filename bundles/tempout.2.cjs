(() => {
  ...
  var init_define_EXODUS_TEST_FILES = __esm({
    "<define:EXODUS_TEST_FILES>"() {
      define_EXODUS_TEST_FILES_default = [["tests/jest/jest-repo/examples/timer/__tests__", "infinite_timer_game.test.js"]];
    }
  });
  ...
  var init_define_process_argv = __esm({
    "<define:process.argv>"() {
      define_process_argv_default = ["exodus-test", "/Users/chalker/repo/Exodus/test/tests/jest/jest-repo/examples/timer/__tests__/infinite_timer_game.test.js"];
    }
  });
...
Also, using expect.assertions() to ensure the planned number of assertions is being called is advised for async code.`
  ...
  // tests/jest/jest-repo/examples/timer/infiniteTimerGame.js
  var require_infiniteTimerGame = __commonJS({
    "tests/jest/jest-repo/examples/timer/infiniteTimerGame.js"(exports, module) {
      "use strict";
      init_define_EXODUS_TEST_FILES();
      init_define_EXODUS_TEST_FSDIRS();
      init_define_EXODUS_TEST_FSFILES();
  ...
  // tests/jest/jest-repo/examples/timer/__tests__/infinite_timer_game.test.js
  var require_infinite_timer_game_test = __commonJS({
    "tests/jest/jest-repo/examples/timer/__tests__/infinite_timer_game.test.js"() {
      "use strict";
      init_define_EXODUS_TEST_FILES();
      init_define_EXODUS_TEST_FSDIRS();
      ...
      init_define_process_argv();
      jest.useFakeTimers();
      var testTimers = !jest.exodus || jest.exodus.features.timers ? test : test.skip;
      testTimers("schedules a 10-second timer after 1 second", () => {
        jest.spyOn(globalThis, "setTimeout");
        const infiniteTimerGame = require_infiniteTimerGame();
        const callback = jest.fn();
        infiniteTimerGame(callback);
        expect(setTimeout).toHaveBeenCalledTimes(1);
        expect(setTimeout).toHaveBeenNthCalledWith(1, expect.any(Function), 1e3);
        jest.runOnlyPendingTimers();
        expect(callback).toHaveBeenCalled();
        expect(setTimeout).toHaveBeenCalledTimes(2);
        expect(setTimeout).toHaveBeenNthCalledWith(2, expect.any(Function), 1e4);
      });
    }
  });
  ...
  (async function() {
    try {
      globalThis.EXODUS_TEST_CRYPTO_ENTROPY = "";
      ;
...
This activity created errors and would have caused tests to fail, but instead triggered unhandledRejection events`);
      ...
      ;
      await Promise.resolve().then(() => __toESM(require_infinite_timer_game_test()));
    } catch (err) {
      print(err);
