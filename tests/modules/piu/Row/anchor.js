...
const anchorableContent = new Row(data, { anchor: "ANCHORABLE_CONTENT" })
assert.sameValue(data["ANCHORABLE_CONTENT"], anchorableContent, "Object should have an anchor");

const ContentTemplate = Row.template($ => ({ anchor: "ANCHORABLE_CONTENT2" }));
...
const ContentTemplate2 = Row.template($ => ({}));
...
const content = new Row(data, { anchor: "CONTENT" });
const container = new Row(data2, { anchor: "CONTAINER", contents: [content] });
const container2 = new Row(data, { anchor: "CONTAINER2", contents: [ container ] });
