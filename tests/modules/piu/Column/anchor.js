...
const anchorableContent = new Column(data, { anchor: "ANCHORABLE_CONTENT" })
assert.sameValue(data["ANCHORABLE_CONTENT"], anchorableContent, "Object should have an anchor");

const ContentTemplate = Column.template($ => ({ anchor: "ANCHORABLE_CONTENT2" }));
...
const ContentTemplate2 = Column.template($ => ({}));
...
const content = new Column(data, { anchor: "CONTENT" });
const container = new Column(data2, { anchor: "CONTAINER", contents: [content] });
const container2 = new Column(data, { anchor: "CONTAINER2", contents: [ container ] });
