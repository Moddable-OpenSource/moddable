...
const anchorableContent = new Label(data, { anchor: "ANCHORABLE_CONTENT" })
assert.sameValue(data["ANCHORABLE_CONTENT"], anchorableContent, "Object should have an anchor");

const ContentTemplate = Label.template($ => ({ anchor: "ANCHORABLE_CONTENT2" }));
...
const ContentTemplate2 = Label.template($ => ({}));
...
const content = new Label(data, { anchor: "CONTENT" });
