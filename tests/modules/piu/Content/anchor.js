...
const anchorableContent = new Content(data, { anchor: "ANCHORABLE_CONTENT" })
assert.sameValue(data["ANCHORABLE_CONTENT"], anchorableContent, "Object should have an anchor");

const ContentTemplate = Content.template($ => ({ anchor: "ANCHORABLE_CONTENT2" }));
...
const ContentTemplate2 = Content.template($ => ({}));
...
const content = new Content(data, { anchor: "CONTENT" });
