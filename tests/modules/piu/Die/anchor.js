...
const anchorableContent = new Die(data, { anchor: "ANCHORABLE_CONTENT" })
assert.sameValue(data["ANCHORABLE_CONTENT"], anchorableContent, "Object should have an anchor");

const ContentTemplate = Die.template($ => ({ anchor: "ANCHORABLE_CONTENT2" }));
...
const ContentTemplate2 = Die.template($ => ({}));
...
const content = new Die(data, { anchor: "CONTENT" });
const container = new Die(data2, { anchor: "CONTAINER", contents: [content] });
const container2 = new Die(data, { anchor: "CONTAINER2", contents: [ container ] });
