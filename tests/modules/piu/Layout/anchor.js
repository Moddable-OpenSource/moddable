...
const anchorableContent = new Layout(data, { anchor: "ANCHORABLE_CONTENT" })
assert.sameValue(data["ANCHORABLE_CONTENT"], anchorableContent, "Object should have an anchor");

const ContentTemplate = Layout.template($ => ({ anchor: "ANCHORABLE_CONTENT2" }));
...
const ContentTemplate2 = Layout.template($ => ({}));
...
const content = new Layout(data, { anchor: "CONTENT" });
const container = new Layout(data2, { anchor: "CONTAINER", contents: [content] });
const container2 = new Layout(data, { anchor: "CONTAINER2", contents: [ container ] });
