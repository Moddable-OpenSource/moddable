...
ifeq ($(DEBUG),1)
	LIB_DIR = $(BUILD_DIR)/tmp/ios-simulator/debug/lib
else
	ifeq ($(INSTRUMENT),1)
		LIB_DIR = $(BUILD_DIR)/tmp/ios-simulator/instrument/lib
	else
		LIB_DIR = $(BUILD_DIR)/tmp/ios-simulator/release/lib
	endif
endif
...
TARGET = -arch i386 -arch x86_64 -isysroot $(SDKROOT) -miphoneos-version-min=6.0
