...
$(BIN_DIR)\$(NAME).exe: $(XS_OBJECTS) $(TMP_DIR)\mc.xs.obj $(OBJECTS)
	@echo # link $(NAME).exe
	link $(LINK_OPTIONS) $(LINK_LIBRARIES) $(XS_OBJECTS) $(TMP_DIR)\mc.xs.obj $(OBJECTS) /implib:$(TMP_DIR)\$(NAME).lib /out:$@
