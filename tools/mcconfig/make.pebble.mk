...
PEBBLE_SDK ?= /Users/mkellner/pebble/pebble-firmware
NRF52_GCC_ROOT ?= /Users/mkellner/opt/arm-gnu-toolchain-14.2.rel1-darwin-arm64-arm-none-eabi
...
FREE_RTOS_PATHS = \
	$(PEBBLE_SDK)/third_party/freertos \
	$(PEBBLE_SDK)/third_party/freertos/FreeRTOS-Kernel/FreeRTOS/Source/include \
	$(PEBBLE_SDK)/third_party/freertos/FreeRTOS-Kernel/FreeRTOS/Source/portable/GCC/ARM_CM4F

PEBBLE_PATHS = \
	$(NRF52_GCC_ROOT)/arm-none-eabi/include \
	$(PEBBLE_SDK)/applib-targets/overrides \
	$(PEBBLE_SDK)/platform/tintin/boot/src \
	$(PEBBLE_SDK)/src/fw \
	$(PEBBLE_SDK)/src/fw/drivers \
	$(PEBBLE_SDK)/src/include \
	$(PEBBLE_SDK)/src/libc/include \
	$(PEBBLE_SDK)/src/libos/include \
	$(PEBBLE_SDK)/src/libutil/includes \

#	$(PEBBLE_SDK)/third_party/cmsis_core/CMSIS/Core/Include
...
XS_HEADERS = \
	...
	$(XS_DIR)/platforms/pebble/xsPlatform.h \
	$(XS_DIR)/platforms/pebble/xsHost.h \
	$(BUILD_DIR)/devices/pebble/config/sdk_config.h \
	$(NRF52_GCC_ROOT)/include
...
SDK_GLUE_HEADERS = \
	$(BUILD_DIR)/devices/pebble/base/app_usbd_vendor.h \
	$(BUILD_DIR)/devices/pebble/base/app_usbd_vendor_internal.h \
	$(BUILD_DIR)/devices/pebble/base/app_usbd_vendor_types.h \
	$(BUILD_DIR)/devices/pebble/base/xsmain.h

HEADERS += $(SDK_GLUE_HEADERS)

SDK_GLUE_DIRS = \
	$(BUILD_DIR)/devices/pebble/base \
...
PEBBLE_DEFINES=\
	-D__STRICT_ANSI__ \
	-DGCC_ARM_CM4F \
	-DBOARD_ASTERIX_EVT1=1 \
	-DMICRO_FAMILY_NRF52840=1 \
	-DMICRO_FAMILY_NRF5=1 \
	-DXS_PEBBLE=1 \
	-DFREERTOS_USE_TIMERS=1	\
	-Dpebble
