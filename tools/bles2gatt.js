...
class GeckoGATTFile extends GATTFile {
	constructor(dictionary) {
		...
		// The 'user' boolean determines whether or not the attribute requests are serviced by the host app.
		// A value of true indicates that requests are routed to and handled by the host app.
		this.user = true;
	}
	generate() {
		let file = this.file;
