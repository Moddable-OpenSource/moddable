...
#include "fips197.h"
	...
	// use 32-bits on ESP8266 to avoid more expensive c_read8
	#define UINT8_TABLE uint32_t
#else
	#define UINT8_TABLE uint8_t
#endif
...
static const uint32_t T1v[] ICACHE_XS6RO_ATTR = {
...
static const uint32_t T2v[] ICACHE_XS6RO_ATTR = {
...
static const uint32_t T3v[] ICACHE_XS6RO_ATTR = {
	...
	static const volatile uint32_t *T1 = T1v;
	static const volatile uint32_t *T2 = T2v;
	static const volatile uint32_t *T3 = T3v;
#else
	#define T0 (T0v)
	#define T1 (T1v)
	#define T2 (T2v)
...
static const uint32_t RT1[] ICACHE_XS6RO_ATTR = {
...
static const uint32_t RT2[] ICACHE_XS6RO_ATTR = {
...
static const uint32_t RT3[] ICACHE_XS6RO_ATTR = {
...
static const UINT8_TABLE RS[] ICACHE_XS6RO_ATTR = {
...
static const UINT8_TABLE rcon[] ICACHE_XS6RO_ATTR = {
...
static const UINT8_TABLE ptab[] ICACHE_XS6RO_ATTR = {
...
static const UINT8_TABLE ltab[] ICACHE_XS6RO_ATTR = {
...
SubByte(uint32_t w)
{
	return ((T0[w & 0xff] >> 8) & 0xff) | (T0[(w >> 8) & 0xff] & 0xff00) | (T0[(w >> 16) & 0xff] & 0xff0000) | ((T0[w >> 24] << 8) & 0xff000000);
}
...
#define ROUND(a0,a1,a2,a3)	(T0[(uint8_t)a0] ^ T1[(uint8_t)(a1 >> 8)] ^ T2[(uint8_t)(a2 >> 16)] ^ T3[(uint8_t)(a3 >> 24)])
...
#define RROUND(a0,a1,a2,a3)	(RT0[(uint8_t)a0] ^ RT1[(uint8_t)(a1 >> 8)] ^ RT2[(uint8_t)(a2 >> 16)] ^ RT3[(uint8_t)(a3 >> 24)])
