...
{
   uint16 minusOne = 0xFFFF;
   switch (i)
   {
      case 0: return 0;
      case 1: return (minusOne<<1) + 1;
      case 2: return (minusOne<<2) + 1;
      case 3: return (minusOne<<3) + 1;
      case 4: return (minusOne<<4) + 1;
      case 5: return (minusOne<<5) + 1;
      case 6: return (minusOne<<6) + 1;
      case 7: return (minusOne<<7) + 1;
      case 8: return (minusOne<<8) + 1;
      case 9: return (minusOne<<9) + 1;
      case 10: return (minusOne<<10) + 1;
      case 11: return (minusOne<<11) + 1;
      case 12: return (minusOne<<12) + 1;
      case 13: return (minusOne<<13) + 1;
      case 14: return (minusOne<<14) + 1;
      case 15: return (minusOne<<15) + 1;		//@@ 1?
      default: return 0;
   }
};
//------------------------------------------------------------------------------
...
static void convertCb(uint8 dstOfs)
{
   ...
   for (i = 64; i > 0; i--)
   {
      ...
      cbG = ((cb * 88U) >> 8U) - 44U;
      *pDstG = subAndClamp(pDstG[0], cbG), pDstG++;

      cbB = (cb + ((cb * 198U) >> 8U)) - 227U;
      *pDstB = addAndClamp(pDstB[0], cbB), pDstB++;
   }
}
/*----------------------------------------------------------------------------*/
...
static void convertCr(uint8 dstOfs)
{
   ...
   for (i = 64; i > 0; i--)
   {
      ...
      crR = (cr + ((cr * 103U) >> 8U)) - 179;
      *pDstR = addAndClamp(pDstR[0], crR), pDstR++;

      crG = ((cr * 183U) >> 8U) - 91;
      *pDstG = subAndClamp(pDstG[0], crG), pDstG++;
   }
}
/*----------------------------------------------------------------------------*/
