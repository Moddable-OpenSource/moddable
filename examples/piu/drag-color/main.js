...
const desktopTexture = new Texture("desktop2.png");
const desktopSkin = new Skin({ texture:desktopTexture, x:0, y:0, width:320, height:320, tiles:{ left:0, right:0, top:0, bottom:0 } });
